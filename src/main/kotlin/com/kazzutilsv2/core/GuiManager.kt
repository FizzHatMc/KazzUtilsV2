...
object GuiManager : PersistentSave(File(KazzUtilsV2.modDir, "guipositions.json")) {
    ...
    fun onRenderHUD(event: RenderHUDEvent) {
        ...
        for ((_, element) in elements) {
            ...
            try {
                ...
                ex.printStackTrace()
                UChat.chat("§cKazzUtilsV2 ${KazzUtilsV2.version} caught and logged an ${ex::class.simpleName ?: "error"} while rendering ${element.name}. Please report this on the Discord server at discord.gg/skytils.")
